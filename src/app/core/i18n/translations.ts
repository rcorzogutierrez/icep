...
export const translations = {
  es: {
    common: {
      ...
      loading: 'Cargando…',
      gradeStatusPassed: 'Aprobado',
      gradeStatusFailed: 'Desaprobado',
      gradeStatusUnfinished: 'No terminado',
      courseEndingSoonDays: 'Este curso termina en',
      courseEndingSoonDaysUnit: 'días.',
      courseAlreadyEndedMessage: 'Este curso ya terminó.',
      unfinishedGradesCount: 'materias todavía sin nota final.',
      unfinishedStudentsCount: 'estudiantes todavía sin nota final en esta materia.',
    },
    login: {
      title: 'Iniciá sesión',
    ...
    gradebook: {
      ...
      errorGeneric: 'No pudimos completar la acción. Probá de nuevo.',
      commentButtonLabel: 'Comentarios',
      commentsTitle: 'Comentarios',
      noComments: 'Todavía no hay comentarios para este estudiante.',
      addComment: 'Agregar comentario',
      commentPlaceholder: 'Unas líneas sobre su desempeño en la materia (opcional)...',
      commentCategoryLabel: 'Categoría (opcional)',
      commentCategoryGeneral: 'General',
      commentAdded: 'Comentario agregado.',
      commentBy: 'por',
      legacyComment: 'Comentario anterior',
      ...
      assignmentAdded: 'Tarea agregada.',
      assignmentSaved: 'Tarea guardada.',
      assignmentDeleted: 'Tarea borrada.',
      resourcesTitle: 'Recursos',
      noResources: 'Todavía no hay recursos para esta materia.',
      addResource: 'Agregar recurso',
      resourceTitleLabel: 'Título',
      resourceTitlePlaceholder: 'Ej. Apuntes de la unidad 3',
      resourceUrlLabel: 'Link',
      resourceUrlPlaceholder: 'https://drive.google.com/...',
      resourceUrlInvalid: 'Ingresá un link válido.',
    ...
    myStudents: {
      ...
      emptyActive: 'Ningún estudiante cursando actualmente.',
      emptyFinished: 'Todavía no tenés estudiantes con cursos finalizados.',
      colStudent: 'Estudiante',
      colCourse: 'Curso',
      ...
      noGradeYet: 'Sin calificar',
      noRubricYet: 'Sin rúbrica',
      save: 'Guardar',
      saved: 'Guardado',
      scoreSaved: 'Nota guardada.',
  ...
  en: {
    common: {
      ...
      loading: 'Loading…',
      gradeStatusPassed: 'Passed',
      gradeStatusFailed: 'Failed',
      gradeStatusUnfinished: 'Unfinished',
      courseEndingSoonDays: 'This course ends in',
      courseEndingSoonDaysUnit: 'days.',
      courseAlreadyEndedMessage: 'This course has already ended.',
      unfinishedGradesCount: "subjects still don't have a final grade.",
      unfinishedStudentsCount: "students in this subject still don't have a final grade.",
    },
    login: {
      title: 'Sign in',
    ...
    gradebook: {
      ...
      noComments: 'No comments for this student yet.',
      addComment: 'Add comment',
      commentPlaceholder: 'A few lines about their performance in the subject (optional)...',
      commentCategoryLabel: 'Category (optional)',
      commentCategoryGeneral: 'General',
      commentAdded: 'Comment added.',
      commentBy: 'by',
      legacyComment: 'Earlier comment',
      rowUnsaved: 'Unsaved',
      ...
      noResources: 'No resources for this subject yet.',
      addResource: 'Add resource',
      resourceTitleLabel: 'Title',
      resourceTitlePlaceholder: 'E.g. Unit 3 notes',
      resourceUrlLabel: 'Link',
      resourceUrlPlaceholder: 'https://drive.google.com/...',
      resourceUrlInvalid: 'Enter a valid link.',
    ...
    myStudents: {
      ...
      emptyActive: 'No students currently enrolled.',
      emptyFinished: "You don't have students with finished courses yet.",
      colStudent: 'Student',
      colCourse: 'Course',
      ...
      noGradeYet: 'Not graded',
      noRubricYet: 'No rubric yet',
      save: 'Save',
      saved: 'Saved',
      scoreSaved: 'Grade saved.',
